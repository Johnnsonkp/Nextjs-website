  ...
  return (
    ...
    <div className="flex items-center justify-center ">
      <MotionLink
        ...
        className="w-12 h-12 bg-dark text-light flex items-center justify-center rounded-full text-2xl font-bold border border-solid border-transparent dark:border-light"
        whileHover={{
          backgroundColor: [
            "#121212",
            "rgba(131,58,180,1)",
